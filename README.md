...
For your final course submission, run `./run.sh` in the CUDA lab and use the generated GPU timings, terminal screenshot, and images as final proof of execution.
